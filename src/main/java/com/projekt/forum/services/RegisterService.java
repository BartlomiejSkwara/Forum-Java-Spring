...
public class RegisterService {
    ...
    public RegisterService(UserRepository userRepository, AuthorityRepository authorityRepository, PasswordEncoder passwordEncoder, HttpServletRequest httpServletRequest) {
    ...
    @Transactional
    public boolean registerNewUser(RegisterForm registerForm) {
